  ...
  return (
    <>
      ...
      >
        ...
        {/* Delete Confirmation Banner (modal within card) */}
        {showDeleteConfirm && (
          <div
        ...
        <div className="grid grid-cols-2 gap-2 pt-2 pb-1">
          ...
          <div className="flex flex-col gap-1">
            ...
            <select
              id="specs-input-performer"
              data-testid="input-specs-performer"
              value={element.performer || element.memberId || ''}
              onChange={(e) =>
                onUpdateElement({ performer: e.target.value, memberId: e.target.value })
              }
              className="w-full px-2.5 py-1.5 rounded-xl text-[11px] font-semibold outline-none transition-all cursor-pointer"
              style={{
                background: isLight ? 'rgba(0, 0, 0, 0.04)' : 'rgba(255, 255, 255, 0.05)',
                border: isLight
                  ? '1px solid rgba(0, 0, 0, 0.08)'
            ...
            >
              <option value="" style={{ background: isLight ? '#fff' : '#18181b' }}>
                — None —
              </option>
              {bandMembers.map((m) => (
                <option
                  key={m.id || m.name}
                  value={m.name}
                  style={{ background: isLight ? '#fff' : '#18181b' }}
                >
                  {m.name}
                </option>
              ))}
          ...
          <div className="flex flex-col gap-1">
            ...
            <input
              id="specs-input-channel"
              data-testid="input-specs-channel"
              type="text"
              value={element.channelId || ''}
              onChange={(e) => onUpdateElement({ channelId: e.target.value })}
              className="w-full px-2.5 py-1.5 rounded-xl text-[11px] font-semibold outline-none transition-all"
              style={{
                background: isLight ? 'rgba(0, 0, 0, 0.04)' : 'rgba(255, 255, 255, 0.05)',
                border: isLight
          ...
          <div className="flex flex-col gap-1">
            ...
            >
              ...
              <input
                ...
                type="number"
                value={rotation}
                onChange={(e) => onUpdateElement({ rotation: parseInt(e.target.value, 10) || 0 })}
          ...
          {moreFieldsExpanded && (
            <div className="grid grid-cols-2 gap-2 pt-1 pb-1">
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  data-testid="input-specs-source"
                  type="text"
              ...
              <div className="flex flex-col gap-1">
                ...
                <input
                  data-testid="input-specs-output"
                  type="text"
                  value={element.output || 'FOH'}
                  onChange={(e) => onUpdateElement({ output: e.target.value })}
                  className="w-full px-2.5 py-1.5 rounded-xl text-[11px] font-semibold outline-none transition-all"
                  style={{
                    background: isLight ? 'rgba(0, 0, 0, 0.04)' : 'rgba(255, 255, 255, 0.05)',
                    border: isLight
