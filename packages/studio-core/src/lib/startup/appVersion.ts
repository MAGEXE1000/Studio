...
export const NATIVE_VERSION = '4.3.59';
export const NATIVE_VERSION_CODE = 40360;
export const WEB_VERSION = '4.3.59';
const cap =
 ...
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_COMMIT_SHA = '2849b1de';

/**
 * Unix epoch timestamp this build was generated.
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_BUILD_TIMESTAMP = '8/4/2026, 5:33:06 PM CST';
