...
function ColorInputsRow({
  ...
  if (format === "hex") {
    ...
    return (
      <div className={hideAlpha ? "grid grid-cols-1" : "grid grid-cols-2 gap-2"}>
        ...
        {!hideAlpha && <AlphaInput value={alphaPct} onCommit={(n) => onChannelChange("alphaPercent", String(n))} />}
      </div>
    );
  }
  ...
  if (format === "rgb") {
    return (
      <div className={hideAlpha ? "grid grid-cols-3 gap-1" : "grid grid-cols-4 gap-1"}>
