...
export const NATIVE_VERSION = '4.3.62';
export const NATIVE_VERSION_CODE = 40363;
export const WEB_VERSION = '4.3.62';
const cap =
 ...
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_COMMIT_SHA = 'd846d8b1';

/**
 * Unix epoch timestamp this build was generated.
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_BUILD_TIMESTAMP = '8/4/2026, 5:59:19 PM CST';
