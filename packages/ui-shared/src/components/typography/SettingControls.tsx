  ...
  return (
    <button
      ...
      style={{
        ...
        border: value ? '2px solid transparent' : '2px solid var(--c-border, rgba(128, 128, 128, 0.24))',
        transition: 'background 280ms cubic-bezier(0.2, 0, 0, 1), border-color 280ms cubic-bezier(0.2, 0, 0, 1)',
        padding: 0,
        display: 'flex',
        alignItems: 'center',
      ...
      {options.map(opt => {
        ...
        return (
          ...
          >
            ...
            <span style={{ position: 'relative', zIndex: 11 }}>
              {opt.label}
            </span>
          </button>
        );
