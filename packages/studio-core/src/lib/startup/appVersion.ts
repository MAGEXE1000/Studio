...
export const NATIVE_VERSION = '4.3.65';
export const NATIVE_VERSION_CODE = 40367;
export const WEB_VERSION = '4.3.65';
const cap =
 ...
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_COMMIT_SHA = '79804da9';

/**
 * Unix epoch timestamp this build was generated.
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_BUILD_TIMESTAMP = '8/4/2026, 6:38:45 PM CST';
