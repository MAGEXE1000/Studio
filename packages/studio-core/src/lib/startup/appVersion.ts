...
export const NATIVE_VERSION = '4.3.66';
export const NATIVE_VERSION_CODE = 40375;
export const WEB_VERSION = '4.3.66';
const cap =
 ...
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_COMMIT_SHA = 'eb7ec50c';

/**
 * Unix epoch timestamp this build was generated.
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_BUILD_TIMESTAMP = '8/4/2026, 6:44:51 PM CST';
