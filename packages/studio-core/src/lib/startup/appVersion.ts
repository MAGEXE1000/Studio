...
export const NATIVE_VERSION = '4.3.58';
export const NATIVE_VERSION_CODE = 40359;
export const WEB_VERSION = '4.3.58';
const cap =
 ...
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_COMMIT_SHA = '2786d3bf';

/**
 * Unix epoch timestamp this build was generated.
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_BUILD_TIMESTAMP = '8/4/2026, 5:26:20 PM CST';
