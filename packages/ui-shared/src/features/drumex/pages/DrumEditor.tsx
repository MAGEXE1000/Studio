                      ...
                      >
                        ...
                        <div className="no-scrollbar flex gap-1.5 overflow-x-auto px-4 pb-3">
                          {(
                            ['All', ...LIBRARY_CATEGORIES, 'My Grooves'] as (
                              LibraryCategory | 'All' | 'My Grooves'
                            )[]
                          ).map((cat) => {
                        ...
                        {libCategory === 'My Grooves' && (
                          <>
                            <div style={{ padding: '0 16px 12px' }}>
                              ...
                              >
                                ...
                                <div style={{ textAlign: 'left' }}>
                                  ...
                                  >
                                    Store "{pattern.name}" to your library
                                  </div>
                                </div>
                              </button>
                            </div>
                              ...
                              >
                                {(['', ...GROOVE_TAGS] as (GrooveTag | '')[]).map((tag) => {
                                  ...
                                  return (
                                    <button
                                      key={label}
                                      onClick={() => setGrooveFilter(tag as GrooveTag)}
                                      className="btn-smooth"
                                      style={{
                                        flexShrink: 0,
                                        padding: '5px 12px',
                                        ...
                                        border: active
                                          ...
                                          : '1.5px solid rgba(128,128,128,0.18)',
                            ...
                            {grooves.length === 0 ? (
                              <div
                                className={`mx-4 mb-6 p-7 border border-dashed rounded-xl flex flex-col items-center justify-center gap-3 text-center ${
                                  isLight
                                    ? 'bg-zinc-50 border-zinc-200'
                                    : 'bg-[#000000] border-zinc-900'
                                }`}
                              >
                                ...
                                <div>
                                  <span
                                    className={`block text-xs font-extrabold uppercase tracking-widest ${isLight ? 'text-zinc-800' : 'text-white'}`}
                                  >
                                    No grooves saved yet
                                  </span>
                                  <span className="block text-[10px] text-zinc-500 font-extrabold uppercase tracking-wide mt-1">
                                    Save any pattern to build your personal library
                                  </span>
                                </div>
                              </div>
                            ) : (
                              ...
                              >
                                {filteredGrooves.map((g) => {
                                  const isPreviewPlaying =
                                    previewingGrooveId === g.id && drumScheduler.isPlaying;
                                    ...
                                    >
                                      {isRenaming ? (
                                        ...
                                        >
                                              ...
                                              (tag) => {
                                                ...
                                                return (
                                                  <button
                                                    key={label}
                                                    onClick={() =>
                                                      setGrooveRenameTag(tag as GrooveTag)
                                                    }
                                                    className="btn-smooth"
                                                    style={{
                                                      flexShrink: 0,
                                          ...
                                          <div style={{ display: 'flex', gap: 6 }}>
                                            <button
                                              onClick={() => setGrooveRenameId(null)}
                                              className="btn-smooth"
                                              style={{
                                                flex: 1,
                                                padding: '7px',
                                        ...
                                        <>
                                          ...
                                          >
                                            ...
                                            <div style={{ flex: 1, minWidth: 0 }}>
                                              ...
                                              >
                                                {g.bpm} BPM Â· {g.bars} bar{g.bars !== 1 ? 's' : ''}
                                              </div>
                                            </div>
                                            <button
                                              onClick={() =>
                                                setGrooveMenuId(menuOpen ? null : g.id)
                                              }
                                              className="btn-smooth"
                                              style={{
                                                width: 32,
                                              ...
                                              >
                                                {[
                                                  ...
                                                  },
                                                  {
                                                    ...
                                                    icon: 'edit',
                                                    action: () => {
                                                      setGrooveRenameName(g.name);
                                                      setGrooveRenameTag(g.tag);
                                                      setGrooveRenameId(g.id);
                                                      setGrooveMenuId(null);
                                                    },
                                                  },
                                                ].map((item, idx) => (
                                                ...
                                                <button
                                                  onClick={() => {
                                                    deleteGroove(g.id);
                                                    setGrooveMenuId(null);
                                                    if (previewingGrooveId === g.id) {
                                                      drumScheduler.stop();
                                                      setPreviewingGrooveId(null);
                                                      setRandomVariations(
                                                        useDrumStore.getState().drumPrefs
                                                          .randomVariations
                                                      );
                                                    }
                                                  }}
                        ...
                        {libCategory !== 'My Grooves' && (
                          ...
                          >
                            {filteredLibrary.length === 0 ? (
                              <div
                                className={`p-7 border border-dashed rounded-xl flex flex-col items-center justify-center gap-3 text-center ${
                                  isLight
                                    ? 'bg-zinc-50 border-zinc-200'
                                    : 'bg-[#000000] border-zinc-900'
                                }`}
                              ...
                              <>
                                {filteredLibrary.slice(0, libVisible).map((lp) => (
                                  <LibCard
                                    ...
                                    lp={lp}
                                    isPreviewPlaying={
                                      previewingGrooveId === lp.id && drumScheduler.isPlaying
                                    }
                                    accent={accent}
                                    isLight={isLight}
                                    onPreview={handleLibPreview}
                                    onReplace={handleLibReplace}
                                    onInsert={handleLibInsert}
                                  />
                                ))}
                                {libVisible < filteredLibrary.length && (
                                  <button
                                    onClick={() => setLibVisible((v) => v + VISIBLE_BATCH)}
                                    style={{
                                      width: '100%',
                                      padding: '14px',
                                      borderRadius: 12,
