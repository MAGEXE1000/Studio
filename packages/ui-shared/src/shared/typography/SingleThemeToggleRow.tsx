...
export default function SingleThemeToggleRow() {
  ...
  // Determine current active theme state: 'light' | 'dark' | 'amoled'
  ...
  return (
    ...
    >
      <button
        ...
        className="w-11 h-11 flex items-center justify-center rounded-full transition-transform active:scale-90 hover:scale-105"
        style={{
      ...
      >
        <AnimatePresence mode="wait" initial={false}>
          {activeState === 'light' && (
            ...
            >
              <SunIcon size={22} color="var(--c-text-primary)" />
            </motion.div>
          )}
          ...
          {activeState === 'dark' && (
            <motion.div
              ...
              className="flex items-center justify-center"
            >
              <MoonIcon size={22} color="var(--c-text-primary)" />
            </motion.div>
          )}
          ...
          {activeState === 'amoled' && (
            <motion.div
              ...
              className="flex items-center justify-center"
            >
              <SunMoonIcon size={22} color="var(--c-text-primary)" />
            </motion.div>
          )}
        </AnimatePresence>
      </button>
