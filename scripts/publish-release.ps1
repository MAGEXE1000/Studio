...
$VersionName = "4.0.20"
$VersionCode = "246"
$ReleaseNote = "v4.0.20 - Redesigned diagnostics dashboard into a high-density, professional engineering console with collapsible sections and lazy rendering."
