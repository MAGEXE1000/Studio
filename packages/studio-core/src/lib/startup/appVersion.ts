...
export const NATIVE_VERSION = '4.5.22';
export const NATIVE_VERSION_CODE = 40522;
export const WEB_VERSION = '4.5.22';
const cap =
 ...
 * Stamped by `scripts/sync-versions.mjs` on build.
 */
export const APP_COMMIT_SHA = 'fe9ae287';

/**
 * Unix epoch timestamp this build was generated.
 * Stamped by `scripts/sync-versions.mjs` on build.
 */
export const APP_BUILD_TIMESTAMP = '8/11/2026, 5:26:07 PM CST';
