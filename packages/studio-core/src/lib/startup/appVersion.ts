...
export const NATIVE_VERSION = '4.3.54';
export const NATIVE_VERSION_CODE = 40354;
export const WEB_VERSION = '4.3.54';
const cap =
 ...
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_COMMIT_SHA = 'cacd5840';

/**
 * Unix epoch timestamp this build was generated.
 * Stamped by `scripts/sync-version.mjs` on build.
 */
export const APP_BUILD_TIMESTAMP = '8/2/2026, 5:59:29 PM CST';
