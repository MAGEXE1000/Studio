import { useChordStore, getChordById, useBackHandler, setNavLocked, setNavHidden, useScrollHide, useT, type SongPreset, useSettingsStore } from '@workspace/studio-core';
/**
