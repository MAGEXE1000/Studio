...
export const NATIVE_VERSION = '4.0.28';
export const WEB_VERSION = '4.0.28';
...
export const APP_VERSION_DATE = '2026-07-11'; // 4.0.28
...
export const APP_CHANGELOG_SECTIONS: ChangelogSection[] = [
  {
    heading: "Added",
    items: [
      "Concurrent version check resolver querying both Firebase Hosting and GitHub Releases concurrently.",
