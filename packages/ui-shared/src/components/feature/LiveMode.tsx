import { getChordById, type GuitarChordData, useChordStore, ACCENT_COLORS, type SongPreset, setNavHidden, transposeChordId, useSettingsStore } from '@workspace/studio-core';
import { useEffect, useRef, useState, useCallback, useMemo } from 'react';
import ElasticSlider from '../progress/ElasticSlider';
    ...
    return (
      ...
      >
        ...
        <button
          ...
          style={{ marginTop: '24px', color: accent.from, fontFamily: 'Manrope', fontWeight: 700 }}
        >
          Close
        </button>
      </div>
            ...
            >
              ...
              <div>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px' }}>
                  {(
                    ...
                    ] as { value: VisualStyle; label: string; icon: string }[]
                  ).map((opt) => (
                    <button
                      key={opt.value}
              ...
              <div>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: '12px' }}>
                  <button
                    onClick={() => setBpmOverride((b) => Math.max(20, b - 10))}
                    className="btn-smooth"
                    style={{
                      width: '36px',
                      height: '36px',
                  ...
                  />
                  <button
                    onClick={() => setBpmOverride((b) => Math.min(300, b + 10))}
                    className="btn-smooth"
                    style={{
                      width: '36px',
                      height: '36px',
