...
```css
[data-studio-theme-vt='active'] ::view-transition-group(root) {
  animation-duration: var(--studio-theme-vt-duration, 380ms);
}
[data-studio-theme-vt='active'] ::view-transition-old(root) {
  animation: none;
  z-index: 1;
}
[data-studio-theme-vt='active'] ::view-transition-new(root) {
  clip-path: var(--studio-theme-vt-clip-from);
  animation: none;
  opacity: 1;
  z-index: 2;
}
